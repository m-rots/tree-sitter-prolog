...
enum {
  ...
  anon_sym_BSLASH_PLUS = 49,
  anon_sym_is = 50,
  aux_sym_variable_token1 = 51,
  aux_sym_variable_token2 = 52,
  anon_sym__ = 53,
  aux_sym__lowercase_atom_token1 = 54,
  anon_sym_SQUOTE = 55,
  aux_sym__quoted_atom_token1 = 56,
  sym_line_comment = 57,
  sym_block_comment = 58,
  sym_source_file = 59,
  sym__definition = 60,
  sym__fact_definition = 61,
  sym_fact = 62,
  sym_rule = 63,
  sym_block = 64,
  sym_parameters = 65,
  ...
  sym_negated_expression = 73,
  sym_numeric_assignment_expression = 74,
  sym_numeric_comparison_expression = 75,
  sym__identifier = 76,
  sym_variable = 77,
  sym_atom = 78,
  sym__lowercase_atom = 79,
  sym__quoted_atom = 80,
...
static inline bool aux_sym__quoted_atom_token1_character_set_1(int32_t c) {
  return (c < 43020
    ? (c < 3976
      ? (c < 2674
        ? (c < 1869
...
static inline bool aux_sym__quoted_atom_token1_character_set_2(int32_t c) {
  return (c < 43052
    ? (c < 3718
      ? (c < 2730
        ? (c < 2042
  ...
  switch (state) {
    ...
    case 7:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') SKIP(7)
      if (aux_sym__quoted_atom_token1_character_set_1(lookahead)) ADVANCE(102);
      END_STATE();
    case 8:
    ...
    case 102:
      ...
      if (aux_sym__quoted_atom_token1_character_set_2(lookahead)) ADVANCE(102);
      END_STATE();
    case 103:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym__lowercase_atom_token1] = ACTIONS(9),
  ...
  [2] = {
    ...
    [anon_sym_rdiv] = ACTIONS(13),
    [anon_sym_rem] = ACTIONS(13),
  ...
  [3] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(17),
    ...
    [anon_sym_AT_GT] = ACTIONS(19),
    [anon_sym_AT_GT_EQ] = ACTIONS(17),
    [anon_sym_BSLASH_EQ] = ACTIONS(19),
    ...
    [anon_sym_rdiv] = ACTIONS(19),
    [anon_sym_rem] = ACTIONS(19),
  ...
  [4] = {
    ...
    [anon_sym_COLON_DASH] = ACTIONS(23),
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(23),
    [anon_sym_EQ_AT_EQ] = ACTIONS(23),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(23),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(23),
    [anon_sym_EQ_LT] = ACTIONS(23),
    [anon_sym_EQ_EQ] = ACTIONS(23),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(23),
    [anon_sym_GT] = ACTIONS(25),
    [anon_sym_GT_EQ] = ACTIONS(23),
    [anon_sym_AT_LT] = ACTIONS(23),
    [anon_sym_AT_EQ_LT] = ACTIONS(23),
    [anon_sym_AT_GT] = ACTIONS(25),
    [anon_sym_AT_GT_EQ] = ACTIONS(23),
    [anon_sym_BSLASH_EQ] = ACTIONS(25),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(23),
    [anon_sym_as] = ACTIONS(23),
    [anon_sym_GT_COLON_LT] = ACTIONS(23),
    ...
    [anon_sym_rdiv] = ACTIONS(23),
    [anon_sym_rem] = ACTIONS(23),
  ...
  [5] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(27),
    [anon_sym_EQ_AT_EQ] = ACTIONS(27),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(27),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(27),
    [anon_sym_EQ_LT] = ACTIONS(27),
    [anon_sym_EQ_EQ] = ACTIONS(27),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(27),
    [anon_sym_GT] = ACTIONS(29),
    [anon_sym_GT_EQ] = ACTIONS(27),
    [anon_sym_AT_LT] = ACTIONS(27),
    [anon_sym_AT_EQ_LT] = ACTIONS(27),
    [anon_sym_AT_GT] = ACTIONS(29),
    [anon_sym_AT_GT_EQ] = ACTIONS(27),
    [anon_sym_BSLASH_EQ] = ACTIONS(29),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(27),
    [anon_sym_as] = ACTIONS(27),
    [anon_sym_GT_COLON_LT] = ACTIONS(27),
  ...
  [6] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(31),
    [anon_sym_EQ_AT_EQ] = ACTIONS(31),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(31),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(31),
    [anon_sym_EQ_LT] = ACTIONS(31),
    [anon_sym_EQ_EQ] = ACTIONS(31),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(31),
    [anon_sym_GT] = ACTIONS(33),
    [anon_sym_GT_EQ] = ACTIONS(31),
    [anon_sym_AT_LT] = ACTIONS(31),
    [anon_sym_AT_EQ_LT] = ACTIONS(31),
    [anon_sym_AT_GT] = ACTIONS(33),
    [anon_sym_AT_GT_EQ] = ACTIONS(31),
    [anon_sym_BSLASH_EQ] = ACTIONS(33),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(31),
    [anon_sym_as] = ACTIONS(31),
    [anon_sym_GT_COLON_LT] = ACTIONS(31),
    ...
    [anon_sym_rdiv] = ACTIONS(31),
    [anon_sym_rem] = ACTIONS(31),
  ...
  [7] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(35),
    [anon_sym_EQ_AT_EQ] = ACTIONS(35),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(35),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(35),
    [anon_sym_EQ_LT] = ACTIONS(35),
    [anon_sym_EQ_EQ] = ACTIONS(35),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(35),
    [anon_sym_GT] = ACTIONS(40),
    [anon_sym_GT_EQ] = ACTIONS(35),
    [anon_sym_AT_LT] = ACTIONS(35),
    [anon_sym_AT_EQ_LT] = ACTIONS(35),
    [anon_sym_AT_GT] = ACTIONS(40),
    [anon_sym_AT_GT_EQ] = ACTIONS(35),
    [anon_sym_BSLASH_EQ] = ACTIONS(40),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(35),
    [anon_sym_as] = ACTIONS(35),
    [anon_sym_GT_COLON_LT] = ACTIONS(35),
  ...
  [8] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(45),
    [anon_sym_EQ_AT_EQ] = ACTIONS(45),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(45),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(45),
    [anon_sym_EQ_LT] = ACTIONS(45),
    [anon_sym_EQ_EQ] = ACTIONS(45),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(45),
    [anon_sym_GT] = ACTIONS(51),
    [anon_sym_GT_EQ] = ACTIONS(45),
    [anon_sym_AT_LT] = ACTIONS(45),
    [anon_sym_AT_EQ_LT] = ACTIONS(45),
    [anon_sym_AT_GT] = ACTIONS(51),
    [anon_sym_AT_GT_EQ] = ACTIONS(45),
    [anon_sym_BSLASH_EQ] = ACTIONS(51),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(45),
    [anon_sym_as] = ACTIONS(45),
    [anon_sym_GT_COLON_LT] = ACTIONS(45),
  ...
  [10] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(59),
    [anon_sym_EQ_AT_EQ] = ACTIONS(59),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(59),
    ...
    [anon_sym_GT_COLON_LT] = ACTIONS(59),
  ...
  [11] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(63),
    [anon_sym_EQ_AT_EQ] = ACTIONS(63),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(63),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(63),
    [anon_sym_EQ_LT] = ACTIONS(63),
    [anon_sym_EQ_EQ] = ACTIONS(63),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(63),
    [anon_sym_GT] = ACTIONS(65),
    [anon_sym_GT_EQ] = ACTIONS(63),
    [anon_sym_AT_LT] = ACTIONS(63),
    [anon_sym_AT_EQ_LT] = ACTIONS(63),
    [anon_sym_AT_GT] = ACTIONS(65),
    [anon_sym_AT_GT_EQ] = ACTIONS(63),
    [anon_sym_BSLASH_EQ] = ACTIONS(65),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(63),
    [anon_sym_as] = ACTIONS(63),
    [anon_sym_GT_COLON_LT] = ACTIONS(63),
  ...
  [19] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(99),
    [anon_sym_EQ_AT_EQ] = ACTIONS(99),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(99),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(99),
    [anon_sym_EQ_LT] = ACTIONS(99),
    [anon_sym_EQ_EQ] = ACTIONS(99),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(99),
    [anon_sym_GT] = ACTIONS(101),
    [anon_sym_GT_EQ] = ACTIONS(99),
    [anon_sym_AT_LT] = ACTIONS(99),
    [anon_sym_AT_EQ_LT] = ACTIONS(99),
    [anon_sym_AT_GT] = ACTIONS(101),
    [anon_sym_AT_GT_EQ] = ACTIONS(99),
    [anon_sym_BSLASH_EQ] = ACTIONS(101),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(99),
    [anon_sym_as] = ACTIONS(99),
    [anon_sym_GT_COLON_LT] = ACTIONS(99),
  ...
  [21] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(103),
    [anon_sym_EQ_AT_EQ] = ACTIONS(103),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(103),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(103),
    [anon_sym_EQ_LT] = ACTIONS(103),
    [anon_sym_EQ_EQ] = ACTIONS(103),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(103),
    [anon_sym_GT] = ACTIONS(105),
    [anon_sym_GT_EQ] = ACTIONS(103),
    [anon_sym_AT_LT] = ACTIONS(103),
    [anon_sym_AT_EQ_LT] = ACTIONS(103),
    [anon_sym_AT_GT] = ACTIONS(105),
    [anon_sym_AT_GT_EQ] = ACTIONS(103),
    [anon_sym_BSLASH_EQ] = ACTIONS(105),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(103),
    [anon_sym_as] = ACTIONS(103),
    [anon_sym_GT_COLON_LT] = ACTIONS(103),
  ...
  [25] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(113),
    [anon_sym_EQ_AT_EQ] = ACTIONS(113),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(113),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(113),
    [anon_sym_EQ_LT] = ACTIONS(113),
    [anon_sym_EQ_EQ] = ACTIONS(113),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(113),
    [anon_sym_GT] = ACTIONS(115),
    [anon_sym_GT_EQ] = ACTIONS(113),
    [anon_sym_AT_LT] = ACTIONS(113),
    [anon_sym_AT_EQ_LT] = ACTIONS(113),
    [anon_sym_AT_GT] = ACTIONS(115),
    [anon_sym_AT_GT_EQ] = ACTIONS(113),
    [anon_sym_BSLASH_EQ] = ACTIONS(115),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(113),
    [anon_sym_as] = ACTIONS(113),
    [anon_sym_GT_COLON_LT] = ACTIONS(113),
  ...
  [26] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(117),
    [anon_sym_EQ_AT_EQ] = ACTIONS(117),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(117),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(117),
    [anon_sym_EQ_LT] = ACTIONS(117),
    [anon_sym_EQ_EQ] = ACTIONS(117),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(117),
    [anon_sym_GT] = ACTIONS(119),
    [anon_sym_GT_EQ] = ACTIONS(117),
    [anon_sym_AT_LT] = ACTIONS(117),
    [anon_sym_AT_EQ_LT] = ACTIONS(117),
    [anon_sym_AT_GT] = ACTIONS(119),
    [anon_sym_AT_GT_EQ] = ACTIONS(117),
    [anon_sym_BSLASH_EQ] = ACTIONS(119),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(117),
    [anon_sym_as] = ACTIONS(117),
    [anon_sym_GT_COLON_LT] = ACTIONS(117),
  ...
  [29] = {
    ...
    [anon_sym_EQ_DOT_DOT] = ACTIONS(127),
    [anon_sym_EQ_AT_EQ] = ACTIONS(127),
    [anon_sym_BSLASH_EQ_AT_EQ] = ACTIONS(127),
    [anon_sym_EQ_COLON_EQ] = ACTIONS(127),
    [anon_sym_EQ_LT] = ACTIONS(127),
    [anon_sym_EQ_EQ] = ACTIONS(127),
    [anon_sym_EQ_BSLASH_EQ] = ACTIONS(127),
    [anon_sym_GT] = ACTIONS(129),
    [anon_sym_GT_EQ] = ACTIONS(127),
    [anon_sym_AT_LT] = ACTIONS(127),
    [anon_sym_AT_EQ_LT] = ACTIONS(127),
    [anon_sym_AT_GT] = ACTIONS(129),
    [anon_sym_AT_GT_EQ] = ACTIONS(127),
    [anon_sym_BSLASH_EQ] = ACTIONS(129),
    [anon_sym_BSLASH_EQ_EQ] = ACTIONS(127),
    [anon_sym_as] = ACTIONS(127),
    [anon_sym_GT_COLON_LT] = ACTIONS(127),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lowercase_atom, 2),
  [15] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lowercase_atom, 2),
  ...
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_atom, 1),
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_atom, 1),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__quoted_atom, 3),
  [29] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__quoted_atom, 3),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 2),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__expression, 1), REDUCE(sym__identifier, 1),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identifier, 1),
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym__expression, 1), REDUCE(sym__identifier, 1),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fact, 1, .production_id = 2),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fact, 1, .production_id = 2),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lowercase_atom, 1),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lowercase_atom, 1),
  [57] = {.entry = {.count = 1, .reusable = false}}, SHIFT(2),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameters, 3),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_assignment_expression, 3),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesized_expression, 4),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesized_expression, 4),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, .production_id = 5),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, .production_id = 5),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fact, 2, .production_id = 3),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fact, 2, .production_id = 3),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 5, .production_id = 7),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictionary, 5, .production_id = 7),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 4, .production_id = 7),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictionary, 4, .production_id = 7),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negated_expression, 2),
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_comparison_expression, 3),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dict_pair, 3, .production_id = 8),
  ...
  [193] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  [196] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(56),
  [199] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(78),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [204] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(45),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 5, .production_id = 6),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fact_definition, 3, .production_id = 3),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fact_definition, 2, .production_id = 2),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 4, .production_id = 4),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__definition, 1, .production_id = 1),
  ...
  [235] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dictionary_repeat1, 2), SHIFT_REPEAT(55),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dictionary_repeat1, 2),
